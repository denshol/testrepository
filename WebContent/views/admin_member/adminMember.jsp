...
<body>
	<div class="wrap">
		...
		<div class="top">
				<table>
					<tr>
						<td onclick="location.href='<%=contextPath%>/member.admin'">회원 조회</td>
					</tr>
				</table>
		</div>
		<div class="middle">
			<div id="mid_search">
				<form action="<%=contextPath%>/searchMember.admin" method="post" id="searchMember-Form" onsubmit="return blankSearch()">
