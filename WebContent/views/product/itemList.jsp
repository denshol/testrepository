            ...
            <div id="con_2">
                ...
                <div id="con_text">
                    ...
                    <div id="ct_price">
                        ...
                        <div id="ct_p2"><%=Math.round((p.getProductSalesRate()*0.01)*p.getProductPrice()) %>원</div>
                        <div id="ct_p3"><%=p.getProductPrice() %>원</div>
                        <div id="ct_p4"><%=Math.round(((p.getProductSalesRate()*0.01)*p.getProductPrice())*0.01) %>p</div>
                    </div>
                    <div id="ct_text">
                        <textarea disabled name="" id="" cols="100" rows="3" style="background-color: white; height: 50px; width: 780px; font-size: 12px; font-weight: 300; border: none; resize: none;">여기에씀
                        </textarea>
                    </div>
                </div>
                <div id="con_btn">
