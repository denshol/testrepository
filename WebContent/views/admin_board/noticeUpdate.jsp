...
<body>
    <div class="wrap">
                ...
                <div>
                    ...
                    <div id="body_foot">
                        <div id="body_foot_div1">
                            <img id="body_foot_img0" src="<%=contextPath%><%=list.get(0).getAttachmentPath()%><%=list.get(0).getAttachmentChange()%>">
                        </div>
                        <div id="body_foot_div2">
                            <img id="body_foot_img1" src="">
                        </div>
                        <div id="body_foot_div3">
                            <img id="body_foot_img2" src="">
                        </div>
                        <div id="body_foot_div4">
                            <img id="body_foot_img3" src="">
                        </div>
                        <!-- 해당 파일번호,파일명 전달 -->
   	...
   	/* 	function chk(){
   	        ...
   	        console.log($("input[name=memberNo]"));
   		}; */
    	...
    	$(function(){
   		...
   		<%for(Attachment at : list) {%>
      		...
      		console.log($("#fileNo"+i).val());
      		console.log($("#fileNo1").val());
