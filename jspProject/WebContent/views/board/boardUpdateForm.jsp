	...
	<div class="outer">
		...
		<form action="<%=contextPath%>/update.bo" method="post" id="update-form" enctype="multipart/form-data">
			...
			<table align="center">
			 	...
			 	<tr>
			 		<th>제목</th>
			 		<td><input type="text" name="title" value="<%=b.getBoardTitle()%>" size="42" required ></td>
			 	</tr>
			 	<tr>
			 		<th>내용</th>
			 		<td>
			 			<textarea name="content" rows="10" cols="45" resized:none; required><%=b.getBoardContent() %></textarea>
			 		</td>
			 	</tr>
			 	<tr>
			 		<th>첨부파일</th>
