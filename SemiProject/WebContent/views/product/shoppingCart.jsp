	        ...
	        <%}else{int i = 1; %> 
	            <%for(ShoppingCart sc : scList){ %>
	            	<div class="row data">
			            ...
			            <div class="subdiv">
			                <div class="basketprice"><input type="hidden" name="p_price" id="p_price1" class="p_price" value="<%=sc.getBookPrice()%>"><span style="text-decoration: line-through;"><%=sc.getBookPrice() %>원</span>(<%=(int)(sc.getBookDc())%>%)</div>
			                <div class="num">
	...
	let basket = {
	    ...
	    delCheckedItem: function(){
		    ...
		    changePNum: function (pos) {
		        ...
		        var price = item.parentElement.parentElement.previousElementSibling.firstElementChild.getAttribute('value');
		        item.parentElement.parentElement.nextElementSibling.textContent = (newval * (price-(price*(dc/100))))+"원";
